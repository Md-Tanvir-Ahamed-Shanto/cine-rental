  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-black/60 backdrop-blur-sm">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[790px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-md dar:bg-[#12141D] rounded-2xl overflow-hidden p-5 md:p-9">
              ...
              >
                <div className="grid grid-cols-[1fr_auto] gap-4">
                  <div className="flex items-center gap-4">
                    <img
                      className="rounded overflow-hidden size-20"
                      src={movie.cover}
                      alt={movie.title}
                    />
                    <div>
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <button onClick={onClose}>
              <a
                className="border border-[#74766F] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dar:text-gray-200 font-semibold text-sm"
                href="#"
              >
                Cancel
              </a>
